...
def detect_issues(code):
    """
    Detect issues in Python code and return structured information:
    grouped by type and including the function/variable name.
    """
    raw_issues = []  
...
def generate_ai_feedback(issues):
    feedback = []
...
def auto_fix_code(code):
    """
    Smart auto-fix:
    - Remove debug prints only
    - Fix spacing inside print
...
def analyze_project(project_path):
    ...
    for file in files:
        ...
        ai_feedback = generate_ai_feedback(issues)
